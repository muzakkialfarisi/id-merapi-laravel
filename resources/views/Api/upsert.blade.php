...
@section('content')
    <form method="post" action="{{ route('main_dealer.api.upsert_process', ['main_dealer_id' => $data['main_dealer']['id'], 'id' => $data->id ?? null]) }}">
        @csrf
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a asp-action="Index" class="btn btn-dark" href="{{ route('main_dealer.api.index', ['main_dealer_id' => $data['main_dealer']['id']]) }}">Back</a>
                </div>   
            </div>
        </div>
    </form>
